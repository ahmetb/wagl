// ----wagl note----
// This package has been copied from https://github.com/docker/docker/blob/master/pkg/tlsconfig/config.go
// for convenience reasons. Please refer to Docker project's license at:
